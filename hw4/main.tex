...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{results/q1_fcnn_summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{results/q1_cnn_summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{results/q5_log.png}
